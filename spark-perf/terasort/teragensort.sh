...
spark-submit --class com.github.ehiggs.spark.terasort.TeraGen --master yarn --deploy-mode cluster spark-terasort-1.1-SNAPSHOT-jar-with-dependencies.jar 10m hdfs:/tmp/spark-tera/in
